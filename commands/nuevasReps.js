...
{   let author = message.member;
    ...
    //EMBED SEA OF THIEVES
        ...
        .addField("EG Gamer", "**46**, __**50**__, **46**, **2**")
        .addField("Hyren", "**45**, __**50**__, **46**, **2**")
    ...
    //EMBED DBD
        ...
        .setColor("#39efbf")
        .setTitle("Reputaciones Actuales")
        .addField("EG Gamer", "**LVL JUGADOR**: *27*")
        .addField("Hyren", "**LVL JUGADOR**: *34*")
        .addField("Fran", "**LVL JUGADOR**: *36*")
